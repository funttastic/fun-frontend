    ...
    <>
      ...
      <div className="text-layer">
        <p>
          ...
          <strong style={{color: '#F2845C'}}>Percentage</strong> <strong>:</strong> The percentage spread is set to 15%.
          This means the buy order will be placed 15% below the current market
          price.<br/>
          <strong style={{color: '#F2845C'}}>Budget</strong> <strong>:</strong> The budget is the amount of money you
          are willing to spend on the buy orders.<br/>
          <strong style={{color: '#F2845C'}}>Ask</strong> <strong>:</strong> Represents a sell order. Sell orders are
          offers to sell an asset at a specific price.
        </p>
      </div>
    </>
  );
